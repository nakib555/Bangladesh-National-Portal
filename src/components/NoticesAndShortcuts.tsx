...
export default function NoticesAndShortcuts() {
  return (
    <>
      <section className="max-w-7xl mx-auto w-full px-0 md:px-4 py-0 md:py-4 grid grid-cols-1 lg:grid-cols-12 gap-0 md:gap-6 select-none bg-white md:bg-transparent">
        
        <div className="lg:col-span-8 bg-white py-5 px-4 md:px-5 md:rounded-xl md:border md:border-gray-200 md:shadow-sm">
      ...
      <section className="max-w-7xl mx-auto w-full px-4 py-4 grid grid-cols-1 md:grid-cols-4 gap-4 bg-white md:bg-transparent">
        <div className="bg-white py-4 md:p-4 md:rounded-xl md:border md:border-gray-200 flex items-start space-x-3.5 hover:shadow-sm transition-shadow border-0">
